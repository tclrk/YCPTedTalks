	...
	<body>
		<form id="reviewForm" name="reviewForm" action="${pageContext.servletContext.contextPath}/reviewPage" method="post">
			<div class="Name">
				...
				<input type="text" name ="name" id="name" size=12 value ="${Review.name}"/><span id="nameError"></span>
			</div>
		
			<div class="Link">
				<label="ted_talk">TED Talk link</label>
				<input type="text" name ="link" id="link" size=12 value ="${Review.link}"/><span id="linkError"></span>
			</div>
		
			<div class="Topic">
				<label="topic">Topic</label>
				<input type="text" name ="topic" id="topic" size=12 value ="${Review.topic}"/><span id="topicError"></span>
			</div>
		
			<div class="Author">
				<label="author">Author</label>
				<input type="text" name = "author" id="author" size=12 value ="${Review.author}"/><span id="authorError"></span>
			</div>
		
			<div class="Description">
				<label="descript">Description</label><br>
				<textarea name= "descript" id="descript" size=12 value ="${Review.descript}"></textarea><span id="descriptError"></span>
			</div>
		
			<div class="Review">
				<label="review">Review</label><br>
				<textarea name= "review" id="review" size=12 value ="${Review.review}"></textarea><span id="reviewError"></span>
			</div>
			
			<div class="starRating">
				 <label="rating">Rating</label><br>
 				 <input id="rating1" type="radio" name="rating" value="${Review.rating}">
 				 <label for="rating1">1</label>
 				 <input id="rating2" type="radio" name="rating" value="${Review.rating}">
 				 <label for="rating2">2</label>
 				 <input id="rating3" type="radio" name="rating" value="${Review.rating}">
  				 <label for="rating3">3</label>
 				 <input id="rating4" type="radio" name="rating" value="${Review.rating}">
  				 <label for="rating4">4</label>
 				 <input id="rating5" type="radio" name="rating" value="${Review.rating}">
